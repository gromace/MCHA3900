...
class MaskRCNN():
    ...
    Inputs:
        ...
        verbose - verbosity mode, 0 = silent, 1 = verbose (default = silent)
    Outputs:
        A list of dicts, with one dict per image, of form:
            {
    ...
    def detect(self, images, verbose=0):
        ...
        assert len(images) == self.config.BATCH_SIZE, "len(images) must be equal to batch size"
        ...
        # Run object detection using keras
        ...
        # Process detections, put into dictionary to return
        results = []
